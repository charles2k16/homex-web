<template>
  <div>
    <section
      class="featured-properties overlay-secondary"
      style="
        background: url(../../assets/images/background/13.jpg) center center /
          cover fixed;
      "
    >
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div
              class="main-title w-75 mx-auto d-table text-center color-white mb-30"
            >
              <span
                class="small-title color-primary position-relative line-2-primary"
                >Find Out the Best One</span
              >
              <h2 class="title mb-20 color-white">Featured Properties</h2>
          ...
          <div class="col-lg-4">
            <div class="property-item">
              ...
              >
                <img
                  src="../../assets/images/property/7.jpeg"
                  alt="image"
                  style="height: 400px"
                />
                <span
              ...
              <div class="property-content bg-white pt-30 pb-50 px-30">
                <a class="color-secondary mb-5" href="singleproperty.html">
                  <h4>park Avanue Apartment.</h4>
                </a>
                <span class="address icon-primary f-14"
                  ><i class="fa fa-map-marker"></i>366 Glenmore Ave, Brooklyn,
                  USA.</span
                >
                <ul
                  class="about-property list-half icon-primary d-table f-14 mb-30 mt-20"
                >
          ...
          <div class="col-lg-4">
            <div class="property-item">
              ...
              >
                <img
                  src="../../assets/images/property/12.jpeg"
                  alt="image"
                  style="height: 400px"
                />
                <span
              ...
              <div class="property-content bg-white pt-30 pb-50 px-30">
                ...
                <span class="address icon-primary f-14"
                  ><i class="fa fa-map-marker"></i>801 Rosedale Ave SE, Atlanta,
                  USA.</span
                >
                <ul
                  class="about-property list-half icon-primary d-table f-14 mb-30 mt-20"
          ...
          <div class="col-lg-4">
            <div class="property-item">
              ...
              <div class="property-content bg-white pt-30 pb-50 px-30">
                ...
                <span class="address icon-primary f-14"
                  ><i class="fa fa-map-marker"></i>14523 Carowinds Blvd,
                  Charlotte, USA.</span
                >
                <ul
                  class="about-property list-half icon-primary d-table f-14 mb-30 mt-20"
